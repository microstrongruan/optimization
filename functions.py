...
class Exponential_fit(MathFunction):
    def __init__(self, m=33):
        self.n=5
        self.m=m
        self.ys = [0.92030594, 0.93702613, 0.94705382, 0.95      , 0.94574947,
                   0.93446831, 0.9165931 , 0.89280288, 0.86397638, 0.8311382 ,
                   0.79539861, 0.75789183, 0.71971751, 0.6818896 , 0.64529556,
                   0.61066788, 0.57856854, 0.5493859 , 0.52334235, 0.50051083,
                   0.48083724, 0.46416647, 0.45026929, 0.43886829, 0.42966102,
                   0.42233956, 0.41660586, 0.41218277, 0.40882122, 0.4063039 ,
                   0.40444619, 0.40309503, 0.40212637]
        MathFunction.__init__(self, self.n)
    def get_expr(self):
        xs = self.xs
        rs = []
